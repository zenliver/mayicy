...
define(function(require,exports) {
    ...
    var Draggable =  Class(Effect)
        ...
        .method({
            bindEffect: function() {
                ...
                //bind
                target.on('http://www.mayicy.cn/Public/kuaiyin/static/js/zz/ui/plugins/mousedown.drag', function(e,_e) {
                    ...
                    $(document).on({'http://www.mayicy.cn/Public/kuaiyin/static/js/zz/ui/plugins/mousemove.drag':function(e) {
                        //解决triggerDrag bug
                        //设置目标offset
                    ...
                    },'http://www.mayicy.cn/Public/kuaiyin/static/js/zz/ui/plugins/mouseup.drag':function(e) {
            ...
            unBindEffect: function() {
                ...
                this.$target.off('http://www.mayicy.cn/Public/kuaiyin/static/js/zz/ui/plugins/mousedown.drag')
    ...
    $.fn.extend({
        ...
        triggerDrag2: function(event) {
            if(this.isState('draggable')) {
                this.trigger('http://www.mayicy.cn/Public/kuaiyin/static/js/zz/ui/plugins/mousedown.drag',event)
            }else {
